...
namespace GatewayApi.Infrastructure.Clients.CustomersApi
{
    ...
    public partial interface ICustomersApiClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="CustomersApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<int> PostCustomerAsync(Customer customer);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="CustomersApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<int> PostCustomerAsync(Customer customer, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class CustomersApiClient : ICustomersApiClient
    {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            ...
                            {
                                throw new CustomersApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        else
                        {
                            ...
                            throw new CustomersApiException("The HTTP status code of the response was not expected (" + status_ + ").", status_, responseData_, headers_, null);
                        }
                    }
                    finally
                    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="CustomersApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<int> PostCustomerAsync(Customer customer)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="CustomersApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<int> PostCustomerAsync(Customer customer, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/Customers");
