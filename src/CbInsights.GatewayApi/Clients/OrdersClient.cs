...
namespace CbInsights.GatewayApi.Clients
{
    ...
    public partial class OrdersClient
    {
        ...
        public OrdersClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
        ...
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Order>> GetCustomerOrdersAsync(int customerId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/customers/{customerId}/orders");
